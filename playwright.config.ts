...
export default defineConfig({
  ...
  testMatch: [
    ...
    '**/06-corrections-flow.spec.ts',
    '**/07-offboarding-flow.spec.ts',
    '**/08-ethics-flow.spec.ts',
    '**/09-training-flow.spec.ts',
    '**/10-statistics-flow.spec.ts',
    '**/11-employee-profile-flow.spec.ts',
    '**/12-survey-checkin-flow.spec.ts',
    '**/13-weekly-report-flow.spec.ts',
  ],
